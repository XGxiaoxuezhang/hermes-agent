...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateHermes: "Update Branch",
    updatingHermes: "Updating branch…",
  ...
  models: {
    ...
    credentialsCtaBody:
      "Pick the main model here. If a provider still needs credentials, jump to Keys and paste the API key; Hermes writes it to ~/.hermes/.env.",
    credentialsCtaTitle: "Configure models and keys together",
