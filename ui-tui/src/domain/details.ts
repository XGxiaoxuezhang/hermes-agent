...
//
//   - thinking: collapsed — reasoning often mirrors provider-side scratchpad
//     language; keep the Chinese dashboard readable by default.
//   - tools: expanded — tool calls stay visible as actionable progress.
